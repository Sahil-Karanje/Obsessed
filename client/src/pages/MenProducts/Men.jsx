...
const Men = () => {
  ...
  return (
    <div>
      <Navbar />
      <h1 style={{ textAlign: 'center' }} className='hidden'>Men's section</h1>
      ...
      <section className='mensProductsContainer'>
        {
          products.map((el) => {
            ...
            if (el.gender === "male" && el.category === "clothes") {
              return (
      ...
      <section className='mensProductsContainer'>
        {
          products.map((el) => {
            ...
            if (el.gender === "male" && el.category === "accessories") {
              return (
                <div div className="commonClothesContainer hidden" >
                  <figure>
                    <Link to={"/product/" + id}> <img src={el.imgUrl} alt="" /></Link>
      ...
      <section className='mensProductsContainer'>
        {
          products.map((el) => {
            ...
            if (el.gender === "male" && el.category === "shoes") {
              return (
                <div div className="commonClothesContainer hidden" >
                  <figure>
                    <Link to={"/product/" + id}><img src={el.imgUrl} alt="" /></Link>
